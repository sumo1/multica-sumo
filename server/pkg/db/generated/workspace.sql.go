...
func (q *Queries) SetWorkspaceDefaultPlanner(ctx context.Context, arg SetWorkspaceDefaultPlannerParams) (Workspace, error) {
	row := q.db.QueryRow(ctx, setWorkspaceDefaultPlanner, arg.ID, arg.DefaultPlannerAgentID)
	var i Workspace
	err := row.Scan(
		&i.ID,
		&i.Name,
